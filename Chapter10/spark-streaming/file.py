...
These files will store content dynamically from 'test.txt' using below code
"""


def main():
    a = 1
    with open('G:/krantirk/spark-streaming-master/test.txt', 'r') as file:  # reading content from 'test.txt' file
